...
public class ModifiedHeap2B{

    private Data3[] theHeap;
    private int itemsInArray = 0;
    private int maxSize;

    public ModifiedHeap2B(int maxSize){
...
// ---------------MODIFIED HEAP SORT for problem 2B--------------- //
            if(root.key < theHeap[largestChild].key){ //if the root is < than the child
                //automatically switch them, a.k.a push it to leaf level
                temp = theHeap[largestChild];
                theHeap[largestChild] = root;
                root = temp;
            }
    ...
    public static void main(String args[]){
        ...
        ModifiedHeap2B newHeap = new ModifiedHeap2B(x);
